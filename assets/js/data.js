 ...
 *   id          唯一标识,详情页靠它取数据(detail.html?id=xxx),中文可以直接用,别重复
 *   title       影视名称        Title
...
window.MEDIA_DB = [
  ...
  //
  // {
  //   id: '片名',                        // 详情页地址 detail.html?id=片名,中文可以直接用,别重复
  //   title: '片名',
  //   category: '电视剧',                // 电影 / 电视剧 / 综艺 / 纪录片
  //   genres: ['类型一', '类型二'],       // 类型标签,第一个是主类型
  //   year: 2005,
  //   region: '中国',
  //   actors: ['演员一', '演员二'],
  //   director: '导演名字',              // 可省
  //   rating: 9.5,                      // 可省,0-10
  //   description: '一段简介……',
  //   resource: 'https://网盘地址',       // 资源入口链接
  //   resourceNote: '提取码 xxxx',        // 可省
  //   added: '2026-09-11',
